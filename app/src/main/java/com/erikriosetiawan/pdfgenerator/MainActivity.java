package com.erikriosetiawan.pdfgenerator;
...
public class MainActivity extends AppCompatActivity {
        ...
        buttonCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editTextContent.getText().toString().isEmpty()) {
                    editTextContent.setError("Isi tulisan terlebih dahulu!");
    ...
    private void createPdfWraper() throws FileNotFoundException, DocumentException {
        int hasWriteStoragePermission = ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        if (hasWriteStoragePermission != PackageManager.PERMISSION_GRANTED) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (!shouldShowRequestPermissionRationale(Manifest.permission.WRITE_CONTACTS)) {
                    showMessageOKCancel("You need to allow access to Storege", new DialogInterface.OnClickListener() {
                        @Override
    ...
    private void createPdf() throws FileNotFoundException, DocumentException {
        ...
        document.open();
        document.add(new Paragraph(editTextContent.getText().toString()));
        document.close();
        previewPdf();
    }
